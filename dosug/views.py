...
def music(request, type=None, sort=None):
    if type == None:
...
def add_event(request):
    ...
    if request.method == "POST":
        ...
        new_event = Event.objects.create(title=title, type=type, tiny_description=short_description, description=description, coordinates=coordinates, address=address)
